			...
			<div className="w-full max-w-5xl">
				<div className="bg-red-100/30 backdrop-blur-xl rounded-3xl shadow-2xl p-8 md:p-12 text-center border border-red-100">
					...
					<p className="text-lg text-gray-600 mb-10 leading-relaxed max-w-2xl mx-auto">
						We couldn&apos;t process your waitlist submission at this time.
					</p>
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
						{[
							{ Icon: RotateCcw, title: "Try Again", desc: "Double-check your email and submit again." },
							{ Icon: Headphones, title: "Contact Support", desc: "Our team is here to help you." },
							{ Icon: Clock, title: "Try Later", desc: "Come back in a few minutes." },
