      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center gap-4 relative">
          <button
            ...
            className="p-2 hover:bg-gray-100 rounded-lg transition active:scale-95 relative"
            aria-label="Notifications"
          >
            <Bell className="h-5 w-5 text-gray-600" />
            {pendingInvitationsCount > 0 && (
              <span className="absolute top-0 right-0 h-5 w-5 bg-red-500 text-white text-xs font-bold rounded-full flex items-center justify-center ring-2 ring-white">
                {pendingInvitationsCount}
              </span>
            )}
          </button>
