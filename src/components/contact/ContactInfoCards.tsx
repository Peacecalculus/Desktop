...
export default function ContactInfoCards() {
	...
	return (
		<div className='space-y-10'>
			{/* Email */}
			<Card className='bg-white border-0 shadow-xl rounded-3xl p-8 flex items-start gap-6 hover:shadow-2xl transition-all duration-500 ease-in-out transform hover:-translate-y-1'>
				...
				<div className='flex gap-5'>
					{socialLinks.map(({ icon: Icon, label, href }) => (
						<a
							...
							className='bg-white/20 hover:bg-white/30 w-14 h-14 rounded-full flex items-center justify-center transition-all duration-500 ease-in-out transform hover:scale-110'>
